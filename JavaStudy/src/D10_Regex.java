...
public class D10_Regex {
   public static void main(String[] args) {
      ...
      // Pattern.matches(regex, input) : input이 regex에 해당하는 문자열인지
      //                           검사하는 메서드
      ...
      System.out.println(Pattern.matches("[cs][lh]e[ea]p", "cleep"));
      ...
      /*
          ...
          .*      : * 앞의 패턴이 0번 이상 나와야 한다
       */
      System.out.println(Pattern.matches("\\d{6}-\\d{7}", "123456-999999"));
      System.out.println(Pattern.matches("\\d{2,4}", "12"));
      System.out.println(Pattern.matches("\\d{5,}", "1234567899a999"));
      ...
      System.out.println();
      String ipAddress = "192.162.0.012"; // 255.255.255.255
...
//      }
      ...
      Pattern appleRegex = Pattern.compile("\\w*apple"); // new 안됨
